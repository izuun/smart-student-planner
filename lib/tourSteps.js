...
// real page. When the next step lives on a different page, the tour does NOT
// switch pages for the user - it shows a "Next stop" guide that points at the
// sidebar link so the user opens the page themselves.

// Friendly names for the switching-page guide (must match the sidebar labels).
...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    title: "Add a Task",
    text: "Fill in a title, subject, priority and due date, then press Add Task. Add your first task to continue the tour!",
    // "Next" stays locked until the user really saves a task (tasks.js calls markDone).
    requires: "task-added",
    requireHint: "Fill in the form and press Add Task to unlock Next.",
    doneHint: "Task added, nice work! Press Next to continue.",
  },
  {
    page: "/tasks",
    target: "tasks-table",
